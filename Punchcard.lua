-- This is a lua adaptation of a regular preset by @Joe. There is very little credit for me in this whole adventure as you can backtrace in this thread https://forum.orthogonaldevices.com/t/8-step-trig-sequencer-unit/2849/12.
local app = app
...
function Punchcard:onLoadGraph(channelCount)
    ...
    for i = 1, numTrigs do
        ...
        localVars["comparator" .. i] = self:createObject("Comparator",
                                                         "comparator" .. i)
        ...
        if i < numTrigs then
            localVars["outputMixer" .. i] =
                self:createObject("Sum", "outputMixer" .. i)
        end
        ...
        connect(localVars["comparator" .. i], "Out", localVars["vca" .. i],
                "Left")
        ...
        self:createMonoBranch("t" .. i, localVars["sw" .. i], "In",
                              localVars["sw" .. i], "Out")
    end
...
local views = {
    expanded = {
        "clock", "reset", "sw1", "sw2", "sw3", "sw4", "sw5", "sw6", "sw7", "sw8"
    },
    collapsed = {}
}
